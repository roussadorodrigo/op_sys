/*Nota: Esta versão do código procura resolver o problema do deadlock invertendo a ordem pela qual metade
dos filósofos pegam nos garfos. Esta solução foi a escolhida porque é simples de implementar (visto já 
se identificar os filósofos através do campo id da sua estrutura), bastando apenas verificar se este valor
é par ou ímpar e, assim, definir a ordem pela qual este pega nos garfos*/
